package com.example.zy09.bean;

import com.example.zy09.R;
...
public class GoodsInfo {
    ...
    private static int[] mThumbArray = {
            R.drawable.suitup_s, R.drawable.hongmi_s, R.drawable.ronyao_s,R.drawable.oppo_s,
            R.drawable.huawei_s, R.drawable.meizu_s, R.drawable.realme_s,R.drawable.iphone_s
    };
    // 声明一个手机商品的大图数组
    private static int[] mPicArray = {
            R.drawable.suitup, R.drawable.hongmi, R.drawable.ronyao,R.drawable.oppo,

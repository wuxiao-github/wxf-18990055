...
import com.example.zz.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Switch sw_statu; // 声明一个复选框对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw_statu = findViewById(R.id.sw_statu);
    ...
    private String[] typeArray = {"18990055-王兴飞","个人用户", "公司用户"};
    ...
    private void initTypeSpinner() {
        ...
        sp_type.setPrompt("18990055-王兴飞");
    ...
    private class RadioListener implements RadioGroup.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            if (checkedId == R.id.rb_password) { // 选择了密码登录
                ...
                sw_statu.setVisibility(View.VISIBLE);
                ...
                sw_statu.setVisibility(View.INVISIBLE);
